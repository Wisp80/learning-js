...
/*Существует обратный метод "Symbol.keyFor(sym)", который, наоборот, принимает глобальный символ и возвращает 
его имя.*/
...
/*В JS существует также ряд встроенных символов, которые позволяют настраивать различные аспекты поведения 
объектов.*/