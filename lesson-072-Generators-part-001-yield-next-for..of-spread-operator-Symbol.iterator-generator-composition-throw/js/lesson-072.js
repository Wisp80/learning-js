...
let arr01_01 = [3, ...generator04];
console.log(arr01_01); // Array [ 3 ], используем "израсходованный" генератор

let generator04_02 = funcGen04();
let arr01_02 = [3, ...generator04_02];
console.log(arr01_02); // Array(4) [ 3, 4, 5, 6 ], используем "новый" генератор
...
console.log('question: ' + question02); // "question: 4 - 4 = ?"
...
/*"yield" можно использовать только в функциях-генераторах.*/
function func01() {
    // yield 1; // Uncaught SyntaxError: yield is a reserved identifier
};