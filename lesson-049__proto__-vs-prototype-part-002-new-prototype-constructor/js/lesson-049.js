...
объект с единственным свойством "constructor", которое ссылается на функцию-конструктор. Соответственно, если мы ничего 
не меняем, то свойство "constructor" будет доступно всем объектам, созданным на основе этой функции-конструктора,
через "[[Prototype]]".*/
function func01() { };
...
прототип по умолчанию на другой объект, то свойства "constructor" в нем не будет.*/
let obj07 = { a: 1 };
...
прототипа по умолчанию вместо того, чтобы перезаписывать его целиком.*/
function func02() { };
let obj09 = { a: 1 };
